...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title><?= $title; ?> | SIP Gempolan</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg fixed-top navbar-dark" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="<?= base_url('awal')?>/assets/img/icon.png" alt="" /><b>SIP GEMPOLAN<b></a>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><i class="fa-solid fa-bars text-white fs-3"></i></button>
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
              <li class="nav-item"><a class="nav-link active" aria-current="page" href="<?php echo base_url('/home/index') ?>">Beranda</a></li>
          ...
          <div class="container">
            <div class="row align-items-center py-lg-8 py-6">
              <div class="col-lg-6 text-center text-lg-start">
                <h1 class="text-white fs-5 fs-xl-6">Posyandu (pos pelayanan terpadu)</h1>
                <p class="text-white py-lg-3 py-2">Posyandu merupakan upaya pemerintah untuk memudahkan masyarakat Indonesia dalam memperoleh pelayanan kesehatan ibu dan anak. Tujuan utama posyandu adalah mencegah peningkatan angka kematian ibu dan bayi saat kehamilan, persalinan, atau setelahnya melalui pemberdayaan masyarakat.</p>
                <div class="d-sm-flex align-items-center gap-3">
                  <button class="btn btn-success text-black mb-3 w-75"><a href="<?php echo base_url('login') ?>"><h5>Sign In</h5></a></button>
                  <button class="btn btn-outline-light mb-3 w-75"><a href="<?php echo base_url('login#signup') ?>"><h5>Sign Up</h5></a></button>
                </div>
              </div>
            ...
            <div class="swiper">
              <div class="swiper-container swiper-shadow swiper-theme" data-swiper='{"slidesPerView":2,"breakpoints":{"640":{"slidesPerView":2,"spaceBetween":20},"768":{"slidesPerView":4,"spaceBetween":40},"992":{"slidesPerView":5,"spaceBetween":40},"1024":{"slidesPerView":4,"spaceBetween":50},"1025":{"slidesPerView":6,"spaceBetween":50}},"spaceBetween":10,"grabCursor":true,"pagination":{"el":".swiper-pagination","clickable":true},"loop":true,"freeMode":true,"autoplay":{"delay":2500,"disableOnInteraction":false}}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide text-center"><img src="<?= base_url('awal')?>/assets/img/logos/boldo.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="<?= base_url('awal')?>/assets/img/logos/presto.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="<?= base_url('awal')?>/assets/img/logos/boldo.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="<?= base_url('awal')?>/assets/img/logos/presto.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="<?= base_url('awal')?>/assets/img/logos/boldo.png" alt="" /></div>
                  <div class="swiper-slide text-center"><img src="<?= base_url('awal')?>/assets/img/logos/presto.png" alt="" /></div>
      ...
      <section>
        ...
        <div class="container">
          ...
          <div class="row gx-xl-7 mt-5">
            <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100" src="<?= base_url('awal')?>/assets/img/services/1.png" alt="" />
            ...
            <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100" src="<?= base_url('awal')?>/assets/img/services/2.png" alt="" />
      ...
      <section>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-6 text-center text-lg-start"><img class="img-fluid" src="<?= base_url('awal')?>/assets/img/offer/1.png" alt="" /></div>
            <div class="col-lg-6">
      ...
      <section class="pt-8 pt-lg-0">
        ...
        <div class="container">
          <div class="d-flex flex-column-reverse flex-lg-row">
            ...
            <div class="col-lg-6 text-center text-lg-end"><img class="img-fluid" src="<?= base_url('awal')?>/assets/img/offer/2.png" alt="" /></div>
          </div>
        </div>
        <!-- end of .container-->
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                  <div class="d-flex flex-column justify-content-between h-100">
                    ...
                    <div class="d-flex align-items-center gap-3 mt-5"><img src="<?= base_url('awal')?>/assets/img/review/2.png" alt="" />
                      <div class="text-black">
                ...
                <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                  <div class="d-flex flex-column justify-content-between h-100">
                    ...
                    <div class="d-flex align-items-center gap-3 mt-5"><img src="<?= base_url('awal')?>/assets/img/review/3.png" alt="" />
                      <div class="text-black">
      ...
      <section>
        ...
        <div class="container"><img class="img-fluid" src="<?= base_url('awal')?>/assets/img/offer/3.png" alt="" />
        ...
        <div class="container">
          ...
          <div class="row mt-7 gx-xl-7">
            <div class="col-md-4 text-center text-md-start h-auto mb-5">
              <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="<?= base_url('awal')?>/assets/img/blog/1.png" alt="" /></a>
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="<?= base_url('awal')?>/assets/img/blog/profile1.png" alt="" /><a href="#">
                    <p class="mb-0 text-gray">Chandler Bing</p>
                  </a></div>
              </div>
            </div>
            <div class="col-md-4 text-center text-md-start h-auto mb-5">
              <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img class="w-75 w-md-100 rounded-2" src="<?= base_url('awal')?>/assets/img/blog/2.png" alt="" /></a>
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mt-3"><a href="#">
                    <p class="fw-bold mb-0 text-black">Category</p>
                  </a>
                  <p class="mb-0">November 22, 2021</p>
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-md-start gap-3"><img class="img-fluid" src="<?= base_url('awal')?>/assets/img/blog/profile2.png" alt="" /><a href="#">
    ...
    <section class="pt-0">
      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-6 col-sm-12"><a href="index.html"><img class="img-fluid mt-5 mb-4" src="<?= base_url('awal')?>/assets/img/black-logo.png" alt="" /></a>
